...
public:
    enum Name {Move, Marquee, EllipseSelection, Rect, Ellipse, Line, BucketTool};
    enum Cursor {Bucket, Cross, CrossPlus, CrossMinus, CrossAnd, Duplicate, Hand, MoveCursor, MoveCut, Selection, SelectLayer};
